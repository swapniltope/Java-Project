...
public class SignupOne extends JFrame  implements ActionListener{
    ...
    long random;
    JTextField nameTextField,snameTextField,mobileTextField,addressTextField,cityTextField,stateTextField,pinTextField ;
    JButton next;
    ...
    JDateChooser dateChooser;
     SignupOne(){
        ...
        add( personDetails );
         ...
         dateChooser.setForeground(new Color(105, 105, 100));
         add(dateChooser);
          ...
          add(female);
           ...
           add(mobileno);
             ...
             mobileTextField.setBounds(300, 340, 400, 30);
             add(mobileTextField);
         ...
         married.setBounds(300, 390, 100, 30);
          ...
          add(unmarried);
           ...
           Other .setBounds(630, 390, 180, 30);
           Other .setBackground(Color.WHITE);
           add(Other);
...
//             phoneTextField.setBounds(300, 590, 700, 30);
//             add(phoneTextField);
     ...
     public void actionPerformed(ActionEvent ae){
         ...
         try{
            if(name.equals("")){
             ...
             Conn  c = new Conn();
             String query = "insert into signup values('" + formno + "','" + name + "','" + sname + "','" + dob + "','" + gender + "','" + mobileno + "','" + marital + "','" + address + "','" + city + "','" + state + "','" + pin + "')";
